...
C_SRCS += \
../Core/Source/NTC/NTC.c 

OBJS += \
./Core/Source/NTC/NTC.o 

C_DEPS += \
./Core/Source/NTC/NTC.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Source/NTC/%.o Core/Source/NTC/%.su Core/Source/NTC/%.cyclo: ../Core/Source/NTC/%.c Core/Source/NTC/subdir.mk
...
clean: clean-Core-2f-Source-2f-NTC

clean-Core-2f-Source-2f-NTC:
	-$(RM) ./Core/Source/NTC/NTC.cyclo ./Core/Source/NTC/NTC.d ./Core/Source/NTC/NTC.o ./Core/Source/NTC/NTC.su

.PHONY: clean-Core-2f-Source-2f-NTC
