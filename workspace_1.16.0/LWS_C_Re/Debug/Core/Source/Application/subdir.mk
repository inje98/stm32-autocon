...
C_SRCS += \
../Core/Source/Application/Application.c 

OBJS += \
./Core/Source/Application/Application.o 

C_DEPS += \
./Core/Source/Application/Application.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Source/Application/%.o Core/Source/Application/%.su Core/Source/Application/%.cyclo: ../Core/Source/Application/%.c Core/Source/Application/subdir.mk
...
clean: clean-Core-2f-Source-2f-Application

clean-Core-2f-Source-2f-Application:
	-$(RM) ./Core/Source/Application/Application.cyclo ./Core/Source/Application/Application.d ./Core/Source/Application/Application.o ./Core/Source/Application/Application.su

.PHONY: clean-Core-2f-Source-2f-Application
