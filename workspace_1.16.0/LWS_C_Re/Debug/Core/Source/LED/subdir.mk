...
C_SRCS += \
../Core/Source/LED/LED.c 

OBJS += \
./Core/Source/LED/LED.o 

C_DEPS += \
./Core/Source/LED/LED.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Source/LED/%.o Core/Source/LED/%.su Core/Source/LED/%.cyclo: ../Core/Source/LED/%.c Core/Source/LED/subdir.mk
...
clean: clean-Core-2f-Source-2f-LED

clean-Core-2f-Source-2f-LED:
	-$(RM) ./Core/Source/LED/LED.cyclo ./Core/Source/LED/LED.d ./Core/Source/LED/LED.o ./Core/Source/LED/LED.su

.PHONY: clean-Core-2f-Source-2f-LED
