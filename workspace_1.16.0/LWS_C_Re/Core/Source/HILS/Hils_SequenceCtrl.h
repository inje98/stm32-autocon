...
#ifndef RTW_HEADER_Hils_SequenceCtrl_h_
#define RTW_HEADER_Hils_SequenceCtrl_h_
...
extern void Hils_SequenceCtrl_Init(void);
extern void Hils_SequenceCtrl(void);

#endif                                 /* RTW_HEADER_Hils_SequenceCtrl_h_ */
