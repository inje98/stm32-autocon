...
#ifndef RTW_HEADER_Hils_Ctrl_Block_h_
#define RTW_HEADER_Hils_Ctrl_Block_h_
#include <math.h>
...
extern void Hils_Ctrl_Block_Init(void);
extern void Hils_Ctrl_Block(void);

#endif                                 /* RTW_HEADER_Hils_Ctrl_Block_h_ */
