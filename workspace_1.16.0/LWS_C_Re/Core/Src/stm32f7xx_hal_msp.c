...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(ER_SCA3_GPIO_Port, ER_SCA3_Pin);

    HAL_GPIO_DeInit(ER_SCL3_GPIO_Port, ER_SCL3_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PG11     ------> SPI1_SCK
    */
    HAL_GPIO_DeInit(GPIOG, MISO_2_Pin|CLK_2_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB14     ------> SPI2_MISO
    */
    HAL_GPIO_DeInit(GPIOB, CLK_1_Pin|MISO_1_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, SCK_3_Pin|MISO_3_Pin|MOSI_3_Pin);
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE14     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, SCK_4_Pin|MISO_4_Pin|MOSI_4_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, SCK_5_Pin|MISO_5_Pin|MOSI_5_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, SCIRXDB_Pin|SCITXDB_Pin);
