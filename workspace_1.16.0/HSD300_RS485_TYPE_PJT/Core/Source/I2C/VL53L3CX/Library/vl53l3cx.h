/**
  ...
  * @brief   This file contains all the functions prototypes for the vl53l3cx.c
  *          driver.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup VL53L3CX_Exported_Constants Exported Constants
  * @{
  */
#define VL53L3CX_ID                 (0xEAAAU)
#define VL53L3CX_ID_REG             (0x010FU)

#define VL53L3CX_DEVICE_ADDRESS     (0x52U)
#define VL53L3CX_NB_TARGET_PER_ZONE (4U)
#define VL53L3CX_MAX_NB_ZONES       (1U)

/* vl53l3cx ranging profiles */
#define VL53L3CX_PROFILE_SHORT      (VL53LX_DISTANCEMODE_SHORT)
#define VL53L3CX_PROFILE_MEDIUM     (VL53LX_DISTANCEMODE_MEDIUM)
#define VL53L3CX_PROFILE_LONG       (VL53LX_DISTANCEMODE_LONG)

/* vl53l3cx ranging modes */
#define VL53L3CX_MODE_BLOCKING_CONTINUOUS (1U)
#define VL53L3CX_MODE_BLOCKING_ONESHOT    (2U)
#define VL53L3CX_MODE_ASYNC_CONTINUOUS    (3U)
#define VL53L3CX_MODE_ASYNC_ONESHOT       (4U)

/* vl53l3cx error codes */
#define VL53L3CX_OK                 (0)
#define VL53L3CX_ERROR              (-1)
#define VL53L3CX_INVALID_PARAM      (-2)
#define VL53L3CX_TIMEOUT            (-3)
#define VL53L3CX_NOT_IMPLEMENTED    (-4)
/**
  * @}
  */

/** @defgroup VL53L3CX_Exported_Types Exported Types
  * @{
 */
extern int32_t Check_1;
extern uint8_t Check_2;
...
typedef int32_t (*VL53L3CX_Delay_Func)(uint32_t);
...
typedef struct
{
  ...
  uint32_t Distance[VL53L3CX_NB_TARGET_PER_ZONE]; /*!< millimeter */
  uint32_t Status[VL53L3CX_NB_TARGET_PER_ZONE];   /*!< 0: OK, 1: NOK */
  float_t Ambient[VL53L3CX_NB_TARGET_PER_ZONE];   /*!< kcps / spad */
  float_t Signal[VL53L3CX_NB_TARGET_PER_ZONE];    /*!< kcps / spad */
} VL53L3CX_TargetResult_t;

typedef struct
{
  uint32_t NumberOfZones;
  VL53L3CX_TargetResult_t ZoneResult[VL53L3CX_MAX_NB_ZONES];
} VL53L3CX_Result_t;
...
} VL53L3CX_Capabilities_t;

typedef struct
{
  int32_t (*Init)(VL53L3CX_Object_t *);
  int32_t (*DeInit)(VL53L3CX_Object_t *);
  int32_t (*ReadID)(VL53L3CX_Object_t *, uint32_t *);
  int32_t (*GetCapabilities)(VL53L3CX_Object_t *, VL53L3CX_Capabilities_t *);
  int32_t (*ConfigProfile)(VL53L3CX_Object_t *, VL53L3CX_ProfileConfig_t *);
  int32_t (*ConfigROI)(VL53L3CX_Object_t *, VL53L3CX_ROIConfig_t *);
  int32_t (*ConfigIT)(VL53L3CX_Object_t *, VL53L3CX_ITConfig_t *);
  int32_t (*GetDistance)(VL53L3CX_Object_t *, VL53L3CX_Result_t *);
  int32_t (*Start)(VL53L3CX_Object_t *, uint32_t);
  int32_t (*Stop)(VL53L3CX_Object_t *);
  int32_t (*SetAddress)(VL53L3CX_Object_t *, uint32_t);
  int32_t (*GetAddress)(VL53L3CX_Object_t *, uint32_t *);
  int32_t (*SetPowerMode)(VL53L3CX_Object_t *, uint32_t);
  int32_t (*GetPowerMode)(VL53L3CX_Object_t *, uint32_t *);
} VL53L3CX_RANGING_SENSOR_Drv_t;
/**
  * @}
  */

/** @defgroup VL53L3CX_Exported_Functions VL53L3CX Exported Functions
  * @{
  */
...
extern VL53L3CX_RANGING_SENSOR_Drv_t   VL53L3CX_RANGING_SENSOR_Driver;
