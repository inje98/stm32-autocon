 ...
 */
/**
 * @brief Definition for COM portx, connected to USART5
 */

#define BUS_UART5_INSTANCE UART5
#define BUS_UART5_TX_GPIO_AF GPIO_AF8_UART5
#define BUS_UART5_TX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE()
#define BUS_UART5_TX_GPIO_PORT GPIOB
#define BUS_UART5_TX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOB_CLK_DISABLE()
#define BUS_UART5_TX_GPIO_PIN GPIO_PIN_3
#define BUS_UART5_RX_GPIO_PORT GPIOB
#define BUS_UART5_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOB_CLK_ENABLE()
#define BUS_UART5_RX_GPIO_AF GPIO_AF8_UART5
#define BUS_UART5_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOB_CLK_DISABLE()
#define BUS_UART5_RX_GPIO_PIN GPIO_PIN_4
...
#define COMn                             1U
#define COM1_UART                        UART5

#define COM_POLL_TIMEOUT                 1000
extern UART_HandleTypeDef hcom_uart[COMn];
//#define  huart5 hcom_uart[COM1]
